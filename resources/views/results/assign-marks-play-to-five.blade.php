...
<ol class="simec_content">
    ...
    <a class="quick_link_right btn btn-success" title="Set Home Works" href="{{ url('./view-results-play-to-five')}}"><i class="fa fa-plus-square"></i> View Results</a> 
</ol>
<div class="grid-form">
	<div class="grid-form1">
    {!! Form::open(['url' => '/assign-marks-play-to-five/create', 'method' => 'post', 'role' => 'form']) !!}
    @csrf
  ...
  $('document').ready(function(){
    ...
    function findAndLoadStudent( class_std = '' , section_std = '' ){
      $.ajax({
        ...
        url     : "{{ route('std-load-for-marking-play-to-five') }}",
        method  : "GET",
