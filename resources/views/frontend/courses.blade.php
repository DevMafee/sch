...
@section('mainContent')
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/pc-1.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/pc-2.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/pc-3.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/pc-4.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="800ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/pc-5.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="900ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/pc-6.jpg);"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="popular-course-details-area wow fadeInUp" data-wow-delay="300ms">
        <div class="single-top-popular-course d-flex align-items-center flex-wrap">
            ...
            <div class="popular-course-thumb bg-img" style="background-image: url({{ asset('public/frontend') }}/img/bg-img/bg-4.jpg);"></div>
        </div>
    </div>
